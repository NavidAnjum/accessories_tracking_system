...
function allowedTabs(): array {
    ...
    $map = [
        ...
        'commercial_dept' => ['customer-profile','sales','single-pi','summary-pi','master-pi','erp-orders-report','bill','lc','sales-contract','exchange','commercial','packing','delivery','truck','origin','beneficiary','forwarding','bank-forwarding','po-status'],
        'commercial'      => ['customer-profile','sales','single-pi','summary-pi','master-pi','erp-orders-report','bill','lc','sales-contract','exchange','commercial','packing','delivery','truck','origin','beneficiary','forwarding','bank-forwarding','po-status'],
    ];
