...
// boxes (EXP/IP, PI numbers) print above the signature — not below it. Falls back
...
function addPiReferencesSalesContract(html,res){const block=piReferenceBlock(res);if(!block)return html;const marker='<div class="sc-contract-accept">';const i=html.indexOf(marker);return i>=0?html.slice(0,i)+block+html.slice(i):insertBeforeLast(html,DOC_BRAND_FOOTER,block)}
